...
var UIColorPicker = (function UIColorPicker() {
    ...
    function ColorPicker(node) {
        ...
        this.newInputComponent('hexa', 'hexa', this.inputChangeHexa.bind(this), {'name' : 'color'});
    ...
    ColorPicker.prototype.newInputComponent = function newInputComponent(title, topic, onChangeFunc, objectConfig = null) {
        ...
        //Sets atributes to element
        if (objectConfig != null) {
        	for (let key in objectConfig) {
                input.setAttribute(key, objectConfig[key]);
			}
		}
